"""Inspect P1-public v5 repair-pair coverage."""
...
def main() -> None:
    ...
    parser.add_argument("--dpo_file", default="data/processed/dpo_train_p1_public_mix_v5.jsonl")
    parser.add_argument("--pair_source", default="public_v4_failure_repair")
