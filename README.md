...
- Integrated public finance QA data from `FinLang/investopedia-instruction-tuning-dataset` (`cc-by-nc-4.0`) and constructed metadata-aware SFT/DPO preference data for P1 experiments.
...
- Reached `100/100/98/100` on compliance, risk disclosure, suitability, and clarification in the best P1-public DPO v6 run.
...
## P1 Public Finance Result

P1 adds public finance QA/advisory data, rule-based cleaning, synthetic user/product metadata, and targeted hard-negative repair pairs. The best public-data DPO run is `P1-public DPO v6`.

| Model | Compliance | Risk Disclosure | Suitability | Clarification | Avg Response Length |
|---|---:|---:|---:|---:|---:|
| Base | 97.0 | 100.0 | 91.0 | 100.0 | 656.66 |
| P1-public SFT | 100.0 | 100.0 | 96.0 | 100.0 | 156.92 |
| P1-public DPO v5 | 100.0 | 97.0 | 100.0 | 100.0 | 147.25 |
| P1-public DPO v6 | 100.0 | 100.0 | 98.0 | 100.0 | 147.83 |

Main takeaway: v6 is the best balanced public-data checkpoint in this run. It fixes the concrete-risk-disclosure failures from earlier DPO variants while preserving full compliance and clarification scores. See `reports/p1_public_v6_rule_summary.md` for the full comparison.
...
| P1 public SFT mix | 8,000 | generated by `scripts/15_prepare_public_finance_data.py` |
| P1 public DPO v6 mix | 8,720 | generated by `scripts/15_prepare_public_finance_data.py --num_repair_dpo 720` |
...
- P1-public v6 rule summary: `reports/p1_public_v6_rule_summary.md`
- P1-public v6 failure spot-check: `reports/p1_public_v6_failure_spotcheck.md`
